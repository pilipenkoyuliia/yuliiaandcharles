...
function Frame() {
  return (
    <div className="content-stretch flex font-['Cormorant_Garamond:Regular',sans-serif] font-normal gap-[26px] h-[46px] items-start justify-center relative shrink-0 w-full whitespace-nowrap">
...
function Frame1() {
  return (
    <div className="content-stretch flex flex-col gap-[18px] items-start relative shrink-0 uppercase w-full">
      <div className="flex flex-col font-['Avenir:Heavy',sans-serif] justify-center relative shrink-0 text-[14px] tracking-[2px] w-full">
        <p className="leading-[13px]">{`Wedding ceremony `}</p>
      </div>
      ...
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center relative shrink-0 text-[13px] tracking-[2.457px] w-full">
        <p className="leading-[16px] mb-0">Vaucresson</p>
        <p className="leading-[16px]">City Hall</p>
      </div>
    </div>
  );
}
...
function Frame3() {
  return (
    <div className="content-stretch flex flex-col gap-[64px] h-[238px] items-start not-italic relative shrink-0 w-[190px]">
      <Frame1 />
      <Frame2 />
    </div>
  );
...
function Frame4() {
  return (
    <div className="content-stretch flex flex-col gap-[17px] items-start not-italic relative shrink-0 uppercase w-full">
      <div className="flex flex-col font-['Avenir:Heavy',sans-serif] justify-center relative shrink-0 text-[14px] tracking-[2px] w-full">
      ...
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center relative shrink-0 text-[13.1px] tracking-[2.457px] w-full whitespace-pre-wrap">
        <p className="leading-[16px] mb-0">{`Château `}</p>
        <p className="leading-[16px]">De Prunay</p>
      </div>
    </div>
  );
}
...
function Frame6() {
  return (
    <div className="content-stretch flex flex-col gap-[64px] h-[227px] items-start relative shrink-0 w-[170px]">
      <Frame4 />
      <Frame5 />
    </div>
  );
...
function Frame8() {
  return (
    <div className="content-stretch flex gap-[90px] items-start relative shrink-0 w-[450px]">
      <Frame3 />
      <Frame6 />
    </div>
  );
...
function Frame9() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute content-stretch flex flex-col gap-[86px] items-start leading-[0] left-[calc(50%+12px)] text-white top-[calc(50%+0.5px)] w-[450px]">
      <Frame7 />
      <Frame8 />
    </div>
  );
